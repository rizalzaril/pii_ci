...
*/
  ...
  function _create_captcha()
  {
    ...
    if ($cap && is_array($cap)) {
      ...
      return $cap['image']; // kembalikan gambar
    } else {
      // Log error supaya bisa dilacak
      log_message('error', 'Captcha creation failed in ' . __METHOD__);

      // Bisa return fallback (misalnya gambar default atau pesan error)
      return '<p style="color:red">Captcha gagal dibuat. Hubungi admin.</p>';
    }
  }
